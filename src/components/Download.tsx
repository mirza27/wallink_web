...
export default function Download() {
    return (
        <div className=" text-center flex h-auto">
            <div className=" bg-white w-auto text-3xl md:text-4xl lg:text-5xl pt-8 pb-4 md:pt-12 lg:pt-16">
                ...
                <div className="pt-8">
                    <Link href="https://play.google.com/store/apps/details?id=com.pens.wallink_v1">
                        <button
                            className=" h-16 w-48 bg-[#1E1F24] text-[#FCFCFD] text-lg rounded-2xl"
                        >
                            Google Play
                        </button>
                    </Link>
